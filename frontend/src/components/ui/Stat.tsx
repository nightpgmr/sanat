...
export function Stat({ value, label }: StatProps) {
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-border/60 bg-surface-elevated/50 p-6 text-center transition-colors hover:border-gold/30">
      ...
      <div className="relative">
        <div className="text-3xl font-black text-gold sm:text-4xl">{value}</div>
